...
// Componente de Card reutilizável baseado na sua imagem
  ...
  return (
    <div className="space-y-12">
      ...
      <div className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-sm">
        <h1 className="text-3xl md:text-4xl font-extrabold mb-2">Bem-vindo à CID, Silas.</h1>
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Usando as cores da sua imagem: Verde para pesquisa, Roxo para inovação, Laranja para extensão */}
          <CategoryCard 
